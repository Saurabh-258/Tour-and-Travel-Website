  ...
  return (
    <div className="about-container">
      ...
      <p>
        ...
        portals. Our invincible expertise and rich expertise has raised our
        spirit to reach ahed from our client's expectations. Commendable sucess
        rate of other portals managed by Trippy ia s live paradigm of our work.
      </p>
